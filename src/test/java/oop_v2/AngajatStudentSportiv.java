...
public class AngajatStudentSportiv extends Persoana{
    ...
    public AngajatStudentSportiv(String nume, String prenume, int varsta, String sex, String adresa, String firma, String pozitie,
                                 int salar, String experienta, String faculta, String domeniu,
                                 int an, boolean bursa, boolean restante, String sport, boolean sportEchipa,
                                 int experienta1, boolean performanta, int medali) {
