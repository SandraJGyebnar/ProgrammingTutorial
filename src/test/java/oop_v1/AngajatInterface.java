...
public interface AngajatInterface {
    //abstractizarea = conceptul prin care putem defiini comportamentul unei clase
    //abstractizarea se poate face prin doua feluri: interfete si clase abstracta
    //interfata contine doar metode abstracte(metode care nu au body)
    // toate aceste metode abstracte sunt publice
    //intr-o interfata putem definii metode cu void sau return
